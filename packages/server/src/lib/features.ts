...
const AUTOMATION_ENV: Record<AutomationFeatureKey, string> = {
  ...
  quality_models: "SPECREG_AUTOMATION_QUALITY_MODELS",
...
const AUTOMATION_CATALOG: Array<FeatureDescriptor<AutomationFeatureKey>> = [
  ...
  { key: "quality_models", label: "QUALITY.md models", description: "Generate governed QUALITY.md rubrics and bridge them to external quality evaluation workflows.", stage: "available" },
